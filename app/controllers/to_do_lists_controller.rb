class ToDoListsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @to_do_list.update(to_do_list_params)
        format.html { redirect_to users_path, notice: 'To do list was successfully updated.' }
   ...
   def destroy
      @to_do_list.destroy
      respond_to do |format|
         format.html { redirect_to users_path, notice: 'To do list was successfully destroyed.' }
  ...
  private
    ...
    def to_do_list_params
      params.require(:to_do_list).permit(:item, :user_id)
    end
end

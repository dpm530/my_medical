class DiagnosesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @diagnosis.save
        format.html { redirect_to patient_path(@diagnosis.patient), notice: 'Diagnosis was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @diagnosis.update(diagnosis_params)
        format.html { redirect_to patient_path(@diagnosis.patient), notice: 'Diagnosis was successfully updated.' }
  ...
  private
    ...
    def diagnosis_params
      params.require(:diagnosis).permit(:onset, :diagnosis, :treatment, :note, :patient_id)
    end
end
